"""
check_dev_correlations.py
=========================
Inspects Pearson correlation of 24h rolling deviations of process variables
...
def main():
    ...
    print("=" * 80)
    print("ROLLING DEVIATIONS VS C4H8_BOTTOM CORRELATION")
    print("=" * 80)
